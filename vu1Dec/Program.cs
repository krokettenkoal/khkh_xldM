...
namespace vu1Dec {
    class Program {
        static void Main(string[] args) {
            if (args.Length < 1) {
                Console.WriteLine("vu1Dec <VU1Micro.kh2>");
                Environment.Exit(1);
            }
            ...
            for (int t = 0; t < 2048; t++) {
                ...
                string su = "?";
                {
                    ...
                    if (false) { }
                        ...
                        p = new Pki("ADDbc." + w.Odest, w.Ofddest, w.Ofsdest, w.Oftbc);
                    }
                        ...
                        p = new Pki("ADDAbc." + w.Odest, w.Oaccdest, w.Ofsdest, w.Oftbc);
                    }
                        ...
                        p = new Pki("MADDbc." + w.Odest, w.Ofddest, w.Ofsdest, w.Oftbc);
                    }
                        ...
                        p = new Pki("MADDAbc." + w.Odest, w.Oaccdest, w.Ofsdest, w.Oftbc);
                    }
                        ...
                        p = new Pki("MAXbc." + w.Odest, w.Ofddest, w.Ofsdest, w.Oftbc);
                    }
                        ...
                        p = new Pki("MINIbc." + w.Odest, w.Ofddest, w.Ofsdest, w.Oftbc);
                    }
                        ...
                        p = new Pki("MSUBbc." + w.Odest, w.Ofddest, w.Ofsdest, w.Oftbc);
                    }
                        ...
                        p = new Pki("MSUBAbc." + w.Odest, w.Oaccdest, w.Ofsdest, w.Oftbc);
                    }
                        ...
                        p = new Pki("MULbc." + w.Odest, w.Ofddest, w.Ofsdest, w.Oftbc);
                    }
                    ...
                    else if (0x1BC == w.M29) { //[MULAbc
                        p = new Pki("MULAbc." + w.Odest, w.Oaccdest, w.Ofsdest, w.Oftbc);
                    }
                        ...
                        p = new Pki("SUBbc." + w.Odest, w.Ofddest, w.Ofsdest, w.Oftbc);
                    }
                        ...
                        p = new Pki("SUBAbc." + w.Odest, w.Oaccdest, w.Ofsdest, w.Oftbc);
                    }
        ...
        class LIW {
            ...
            public string Oimm11isdest { get { return "$" + (imm11s * 16).ToString("x") + "(" + Ois + ")"; } }
            public string Odest {
                get {
                    string text = "";
                    if (0 != (dest & 8)) text += "x";
            ...
            public string Oimm11is { get { return "$" + (imm11s * 16).ToString("x") + "(" + Ois + ")"; } }
            ...
            public string Oimm11it { get { return "$" + (imm11s * 16).ToString("x") + "(" + Oit + ")"; } }
    ...
    class BUtil {
        public static string B32Toa(uint val) {
            string text = "";
            for (byte x = 0; x < 32; x++) {
                text += ((1 & (val >> (31 - x))) != 0) ? '1' : '0';
            }
            return text;
        }
        public static string B7455542Toa(uint val) {
            string text = "";
            for (byte x = 0; x < 32; x++) {
                switch (x) {
                    case 7:
