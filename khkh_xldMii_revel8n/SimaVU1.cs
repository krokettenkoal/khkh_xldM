    ...
    public class SimaVU1 {
        public static Body1 Sima(VU1Mem vu1mem, Matrix[] Ma, int tops, int top2, int tsel, int[] alaxi, Matrix Mv) {
            ...
            if (v28 != 0)
            {
                ...
                int[][] allocalbi = new int[v30][];
                float[][] allocalbw = new float[v30][];
                ...
                for (weightLimit = 0; weightLimit < v28; ++weightLimit)
                {
                    si.Position = cpos;
...
//                 }
    ...
    public class Body1 {
        ...
        public int[][] albi = null; // joint indices
        public float[][] albw = null; // joint weights
