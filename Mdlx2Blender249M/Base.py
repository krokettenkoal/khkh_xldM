...
class Aniut2:
	@staticmethod
	def SetPoseMtx(actionName, bone, alBlk):
		...
		for al in alBlk:
			...
			for joint in al['joints']:
				...
				m = joint['matrix']
				b.localMatrix = Blender.Mathutils.Matrix(m[0], m[1], m[2], m[3])
				b.insertKey(mybone.armObj, frame, [Blender.Object.Pose.SIZE, Blender.Object.Pose.ROT, Blender.Object.Pose.LOC], True)
