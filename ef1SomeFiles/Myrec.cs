...
namespace ee1Dec {
    ...
    public class Myrec {
        ...
        public static void Rec1(uint addr, out CodeMemberMethod fn, Stream sieeMem) {
            ...
            while ((exitVal--) != 0) {
                ...
                if (cti is CodeOptiOne) {
                    ...
                    EEis o = ee1Dec.EEDisarm.parse(word, pc);
                    ...
                    if (true) {
                        ...
                        EEis o = ee1Dec.EEDisarm.parse(ct16.w0, pc);
                        fns.Add(new CodeCommentStatement(new CodeComment("@" + pc.ToString("X8") + "   " + o.ToString())));
                        addr += 4; pc = addr;
                    }
                    if (true) {
                        EEis o = ee1Dec.EEDisarm.parse(ct16.w1, pc);
                        fns.Add(new CodeCommentStatement(new CodeComment("@" + pc.ToString("X8") + "   " + o.ToString())));
                        addr += 4; pc = addr;
                    }
                    if (true) {
                        EEis o = ee1Dec.EEDisarm.parse(ct16.w2, pc);
                        fns.Add(new CodeCommentStatement(new CodeComment("@" + pc.ToString("X8") + "   " + o.ToString())));
                        addr += 4; pc = addr;
                    }
                    if (true) {
                        EEis o = ee1Dec.EEDisarm.parse(ct16.w3, pc);
                        fns.Add(new CodeCommentStatement(new CodeComment("@" + pc.ToString("X8") + "   " + o.ToString())));
                        addr += 4; pc = addr;
                    }
        ...
        public static void Privrec1(uint addr, Stream sieeMem, string dir) {
            ...
            Debug.WriteLine("Å®Å®Å® Å®Å®Å® Å®Å®Å®");
