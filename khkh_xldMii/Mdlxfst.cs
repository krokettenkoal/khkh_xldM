...
namespace khkh_xldMii.Mx {
    public class T31 {
        ...
        public Matrix[] Ma = null; // skeleton base pose
        public Matrix[] Minv = null; // skeleton inverse transforms
    ...
    public class Mdlxfst {
        ...
        public Mdlxfst(Stream fs) {
            ...
            Queue<int> aler = new Queue<int>();
            aler.Enqueue(0x90);
            int postbl3 = 0;
            while (aler.Count != 0) {
                int eroff = aler.Dequeue();
                ...
                for (int c1 = 0; c1 < cnt1; c1++) {
                    ...
                    T11 t11;
                    t31.al11.Add(t11 = new T11(pos2, RUtil.RoundUpto16(4 + 4 * cnt1a), c1));
                    ...
                    T12 t12;
                    t31.al12.Add(t12 = new T12(pos1, pos1a - pos1, c1));
